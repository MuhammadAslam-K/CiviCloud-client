...
export default function EmployeeTransactions() {
    ...
    const initialTransactions = [
        ...
        { id: 2, createdDate: "2025-02-14", type: "debit", reason: "other", reasonDetail: "Equipment Purchase Equipment Purchase Equipment Purchase Equipment Purchase Equipment Purchase" },
    ...
    return (
        <div className="max-w-2xl p-4 mx-auto bg-white rounded-lg shadow-sm">
            <h2 className="mb-4 text-xl font-semibold text-center text-gray-800 sm:text-2xl">Employee Transactions</h2>
                            ...
                            >
                                <div className="flex flex-col gap-1">
                                    ...
                                    <div className="flex items-center gap-1">
                                        ...
                                        <p
                                            className="w-full text-sm text-gray-800 truncate sm:text-base"
                                            title={transaction.reasonDetail}
                                        >
